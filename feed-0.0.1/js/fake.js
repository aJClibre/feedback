...
feed.fake = (function () {
    ...
    makeFakeIdR = function () {
        return 'id_' + String( fakeIdSerialR++ );
    };
    ...
    reportsList = [
        {
            title : 'titre 1', _id : 'id_01',
            locate_map : { x: 25, y: 44 }
        },{
            title : 'titre 2', _id : 'id_02',
            locate_map : { x: 28, y: 54 }
        },{
            title : 'titre 3', _id : 'id_03',
            locate_map : { x: 30, y: 48 }
        }
        ];
    ...
    mockSioReport = (function () {
        ...
        emit_sio = function ( msg_type, data ) {
            ...
            // callback after a 3s delay
            //
            if ( msg_type === 'addreport' && callback_map.reportupdate ) {
                setTimeout( function () {
                    report_map = { 
                        _id         : makeFakeIdR(),
                        title       : data.title,
                    ...
                    callback_map.reportupdate([ report_map ]);
                }, 3000 );
            }
            ...
            if ( msg_type === 'updatereport' && callback_map.listchange ) {
                ...
                for ( i = 0; i < reportsList.length; i++ ) {
                    if ( reportsList[ i ]._id === data.report_id ) {
